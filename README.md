...
This is the final predicted schedule for the 2026 NFL season, built with integer linear programming. Every game gets a week and a kickoff time, including primetime slots, international games, Thanksgiving, Black Friday, and Christmas. As the NFL officially announced games, confirmed matchups were locked in and the rest of the schedule was re-solved around them.
...
As the NFL announced official games (international matchups, primetime slots, Thanksgiving, etc.), they were added to `data/confirmed_games.json`. The ILP solver locked those in and filled the rest of the schedule around them.
